...
const FeedbackCard = ({content, name, title , img}) => {
  ...
  return (
    ...
    mr-0 my-5 
    '>
      <p className='font-poppins font-bold font-normal text-[18px] leading-[32px] text-black my-10 ' ref={cardsRef1}>
        {content}
      </p>
      <p className='font-poppins  font-normal text-[18px] leading-[32px] text-black' ref={cards2Ref2}>{name}</p>
